...
export default async function setUp() {
    ...
    const source_0_editor = createEditor({ container: document.querySelector("#source-0-wrap"), language: "c", value: source_0 });
    const source_1_editor = createEditor({ container: document.querySelector("#source-1-wrap"), language: "c", value: source_1 });
